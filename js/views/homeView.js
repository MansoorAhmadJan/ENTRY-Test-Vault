...
(function (App) {
  ...
  function render(container) {
    ...
    container.innerHTML = `
      ...
      <div class="section">
        <div class="card">
          <div class="section-title home-progress-title">
            <strong>Progress Overview</strong>
            <span class="home-progress-count">${progress.counts.Completed} of ${progress.total} completed</span>
          </div>
          <div class="progress-bar home-progress-bar-wrap">
            <div class="progress-bar-fill" data-progress-fill></div>
          </div>
          <div class="rc-meta rc-meta--flush">
      ...
      ${
        continuing
          ? `
      <div class="section">
        <div class="card home-continue-card">
          <div>
            <div class="section-title home-continue-title"><strong>Continue Studying</strong></div>
            <div class="home-continue-name">${App.Utils.escapeHtml(continuing.title)}</div>
            <div class="home-continue-meta">${continuing.id} · ${App.Utils.escapeHtml(continuing.university)} · marked In Progress</div>
          </div>
    ...
    container.querySelector("[data-progress-fill]").style.width = `${progress.pct}%`;
